<template>
  <div class="viz-settings">
    ...
    <div class="deep-box">
      ...
      <label>허용 최대 평가 손실(cp) <input v-model.number="openingBookLocal.autoGenerateMaxEvalLossCp" min="20" max="600" type="number" @change="saveOpeningBook"></label>
      <label>최소 신뢰 누적 횟수 <input v-model.number="openingBookLocal.autoGenerateMinTrustedCount" min="0" max="30" type="number" @change="saveOpeningBook"></label>
